  ...
  <div style="width:100%; display: flex;
    justify-content: space-around">
              ...
              <divide-line>商品基础信息</divide-line>
                ...
                <br>
                <!-- <div class="flex">
                    <Button type="success"  style="width:120px;margin:0 auto;margin-top:20px;" @click="modal=true">修改完成</Button>
                    <Button type="success"  style="width:120px;margin:0 auto;margin-top:20px;" @click="modal1=true">删除商品</Button>
                </div> -->
             ...
             <div style="width:100%">
                    ...
                    <Button type="primary"  style="float:right;width:120px;" @click="modal1=true">删除商品</Button>
                </div>
    </div>
</template>
<script>
